...
@Component({
    selector: 'app-horizontal-topbar-entreprises',
    templateUrl: './horizontal-topbar-entreprises.component.html',
    styleUrls: ['./horizontal-topbar-entreprises.component.scss'],
    standalone: false
})
export class HorizontalTopbarEntreprisesComponent implements OnInit {
