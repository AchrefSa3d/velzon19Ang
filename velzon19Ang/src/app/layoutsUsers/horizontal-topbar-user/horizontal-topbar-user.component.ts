...
@Component({
    ...
    templateUrl: './horizontal-topbar-user.component.html',
    styleUrls: ['./horizontal-topbar-user.component.scss'],
    standalone: false
})
export class HorizontalTopbarUserComponent implements OnInit {
